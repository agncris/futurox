  ...
  return (
    <section id="contacto" style={contactSiteStyles.section}>
      <div style={contactSiteStyles.inner} data-site="contact-inner">
        <div>
          <div style={contactSiteStyles.eyebrow}>{t("contact.eyebrow")}</div>
          <h2 style={contactSiteStyles.title}>
            <span>{t("contact.title.1")} </span>
            <br/>
            <span>{t("contact.title.2")}<span style={{ color: "var(--coral-500)" }}>{t("contact.title.acc")}</span>{t("contact.title.3")}</span>
          </h2>
          ...
          <div style={contactSiteStyles.meta}>
            <div style={contactSiteStyles.metaRow}>
              <span style={contactSiteStyles.metaLabel}>{t("contact.meta.email")}</span>
              <span style={contactSiteStyles.metaValue}>hola@futurox.cl</span>
            </div>
            <div style={contactSiteStyles.metaRow}>
              <span style={contactSiteStyles.metaLabel}>{t("contact.meta.phone")}</span>
              <span style={contactSiteStyles.metaValue}>+56 9 5108 7502</span>
            </div>
            <div style={contactSiteStyles.metaRow}>
              <span style={contactSiteStyles.metaLabel}>{t("contact.meta.address")}</span>
              <span style={contactSiteStyles.metaValue}>10 Norte 882, Viña del Mar</span>
            </div>
            <div style={{ ...contactSiteStyles.metaRow, borderBottom: 0 }}>
              <span style={contactSiteStyles.metaLabel}>{t("contact.meta.hours")}</span>
              <span style={contactSiteStyles.metaValue}>{t("contact.meta.hours.value")}</span>
            </div>
          </div>
        </div>
        ...
        {sent ? (
          <div style={contactSiteStyles.done}>
            ...
            <div>
              <h3 style={contactSiteStyles.doneTitle}>{t("contact.done.title.1")}<br/>{t("contact.done.title.2")}</h3>
          ...
          <form style={contactSiteStyles.form} onSubmit={onSubmit}>
            <FieldSite label={t("contact.form.name")} name="name_org" required
                       placeholder={t("contact.form.name.ph")} />
            <FieldSite label={t("contact.form.email")} type="email" name="email" required
                       placeholder={t("contact.form.email.ph")} />
            <FieldSite label={t("contact.form.msg")} as="textarea" name="message"
