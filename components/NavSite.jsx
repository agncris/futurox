...
const NavSite = ({ current = "" }) => {
  ...
  const items = [
    ...
    { id: "nosotros",  label: "Equipo",     href: "#nosotros" },
    ...
    <React.Fragment>
      <header style={navSiteStyles.wrap}>
        <div style={navSiteStyles.inner} data-site="nav-inner">
          <a href="#top" style={navSiteStyles.brand} aria-label="FUTUROX inicio">
          ...
          <nav style={navSiteStyles.links} data-site="nav-links">
            ...
            <Button variant="secondary" withArrow href="#contacto">Conversemos</Button>
          </nav>
      ...
      {/* Mobile sheet */}
      {open ? (
        <div style={navSiteStyles.sheet} role="dialog" aria-modal="true" aria-label="Menú">
          <div style={navSiteStyles.sheetHead}>
            <a href="#top" style={navSiteStyles.brand} onClick={onSheetNav} aria-label="FUTUROX inicio">
              <ArcMark size={22} stroke={1.8} color="var(--ink-900)" />
              <Wordmark height={16} color="var(--ink-900)" />
            </a>
          ...
          <div style={navSiteStyles.sheetFooter}>
            <span style={navSiteStyles.sheetMeta}>Viña del Mar · LATAM</span>
            <LinkedInGlyph href="https://www.linkedin.com/company/futurox/" />
          </div>
        </div>
      ) : null}
